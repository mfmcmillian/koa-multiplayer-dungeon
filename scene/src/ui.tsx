...
const addItemToInventory = (item: { id: number; name: any; quantity: number; attackpower: number; spellpower: number; hp: number }) => {
  inventory = [...inventory, item];
};

let isInfoMenuOpen: boolean = false;
let selectedItemDetails: { id: number; name: any; quantity: number; attackpower: number; spellpower: number; hp: number } | null = null;

const openInfoMenu = (itemDetails: { id: number; name: any; quantity: number; attackpower: number; spellpower: number; hp: number }) => {
  isInfoMenuOpen = true;
