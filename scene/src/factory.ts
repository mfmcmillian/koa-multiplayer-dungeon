import { LogInventoryToLordServer } from './api/api'
...
export const UpdateLordInventory = (state: Inventory, payload: Payload): Inventory => {
  ...
  LogInventoryToLordServer(payload.type, payload.itemKey, payload.count)
    .then(() => {
